 ...
 */
abstract class BaseGuiaGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%code%% - %%name%% - %%url%% - %%description%% - %%tool_id%%';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'code',  2 => 'name',  3 => 'url',  4 => 'description',  5 => 'tool_id',);
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'tool_id' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'ForeignKey',),
    );
  }
