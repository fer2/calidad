 ...
 */
abstract class BaseSolicitudGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%name%% - %%state%% - %%description%% - %%company_id%%';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'name',  2 => 'state',  3 => 'description',  4 => 'company_id',);
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'company_id' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'ForeignKey',),
    );
  }
